...
panel_thickness = 4.2;
panel_radius = 35.5;//77
hole_radius = 39.0;
top_inner_flange = .75;
top_outer_flange =3.5;
...
union(){
    difference(){
        ...
        cylinder(h=panel_thickness + bottom_thickness, r=panel_radius);
 ...
 * translate([-panel_radius,0,panel_thickness-grill_radius+grill_trim+.09])
    ...
    translate([0,0,panel_thickness-grill_radius+grill_trim/2]){
